...
function typing(){const message=t({en:'One moment, I am checking your request...',ko:'잠시만 기다려 주세요. 문의 내용을 확인하고 있습니다...',tl:'Sandali lang, chine-check ko ang request mo...'});const row=document.createElement('div');row.className='message-row typing-row';row.innerHTML=`<div class="avatar">F</div><div class="bubble-wrap"><div class="bubble">${message}</div><div class="meta">Festrips AI Assistant | Just now</div></div>`;chatBody.append(row);chatBody.scrollTop=chatBody.scrollHeight;return row;}
